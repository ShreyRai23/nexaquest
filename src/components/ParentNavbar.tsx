  ...
  return (
    <header className="sticky top-3 z-50 px-3 sm:px-6">
      <nav className="mx-auto max-w-7xl pixel-card-flat flex items-center justify-between gap-3 px-3 py-2"
        ...
        <Link to="/parent" className="flex items-center gap-2 pl-1">
        ...
        <div className="flex items-center gap-2">
          <div className="relative">
            <button onClick={()=>setOpen(o=>!o)} className="flex items-center gap-2 rounded-xl border-4 border-[color:var(--ink)] bg-[color:var(--sunny)] px-2 py-1.5 shadow-[3px_3px_0_0_var(--ink)]">
              ...
              <span className="font-pixel text-[9px] text-[color:var(--ink)]">{active.name.toUpperCase()}</span>
          ...
          <div className="grid h-10 w-10 place-items-center rounded-full border-4 border-[color:var(--ink)] bg-[color:var(--teal-pop)] shadow-[3px_3px_0_0_var(--ink)]">
            <span className="font-pixel text-[10px] text-[color:var(--ink)]">PA</span>
          </div>
          <button onClick={switchToChild} title="Switch to Child" className="hidden md:grid h-10 w-10 place-items-center rounded-full border-4 border-[color:var(--ink)] bg-[color:var(--cherry)] shadow-[3px_3px_0_0_var(--ink)]" aria-label="Switch to child">
